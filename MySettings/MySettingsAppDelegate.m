...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    if (![defaults objectForKey:@"event"])
        [defaults setObject:@"location" forKey:@"location"];
    if (![defaults objectForKey:@"location"])
        [defaults setObject:@"location" forKey:@"location"];
    [defaults synchronize];self.window = [[UIWindow alloc] initWithFrame:[[UIScreen mainScreen] bounds]];
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"MySettings" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"MySettings.sqlite"];
